...
- ✅ Працюй автономно **в межах docs домену** (markdown, technical writing)
- ✅ **Якщо потрібен технічний контекст поза доменом:**
  - Status: Blocked, Domain: backend | frontend | database, Required: "Specific technical info"
