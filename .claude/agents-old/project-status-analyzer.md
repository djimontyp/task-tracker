...
- ✅ Працюй автономно **в межах project analysis домену** (metrics, status)
- ✅ **Якщо потрібен контекст поза доменом:**
  - Technical implementation details → Status: Blocked, Domain: backend | frontend, Required: "Specific technical info"
