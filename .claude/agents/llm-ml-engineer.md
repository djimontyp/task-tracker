...
- ✅ Працюй автономно **в межах LLM/ML домену** (model training, inference)
- ✅ **Якщо потрібен контекст поза доменом:**
  - Prompt engineering → Status: Blocked, Domain: prompts, Required: "Current prompt template"
  - Cost optimization → Status: Blocked, Domain: cost, Required: "Token usage patterns"
