...
- ✅ Працюй автономно **в межах code style домену** (formatting, cleanup)
- ✅ **Якщо потрібен контекст поза доменом:**
  - Code logic context → Status: Blocked, Domain: backend | frontend, Required: "Code behavior explanation"
