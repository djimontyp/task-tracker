...
- ✅ Працюй автономно **в межах UX/UI домену** (design, accessibility)
- ✅ **Якщо потрібен контекст поза доменом:**
  - Product strategy → Status: Blocked, Domain: product, Required: "User research findings"
  - Implementation details → Status: Blocked, Domain: frontend, Required: "Component structure"
