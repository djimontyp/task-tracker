...
- ✅ Працюй автономно **в межах DevOps домену** (Docker, CI/CD, infrastructure)
- ✅ **Якщо потрібен контекст поза доменом:**
  - Application requirements → Status: Blocked, Domain: backend, Required: "Service dependencies"
