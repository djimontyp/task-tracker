...
def upgrade() -> None:
    ...
    op.alter_column('simple_messages', 'content',
               existing_type=sa.VARCHAR(),
               type_=sa.Text(),
               existing_nullable=False)
    op.alter_column('simple_tasks', 'description',
               existing_type=sa.VARCHAR(),
               type_=sa.Text(),
               existing_nullable=False)
...
def downgrade() -> None:
    ...
    op.create_index(op.f('ix_task_ai_generated'), 'tasks', ['ai_generated'], unique=False)
    op.alter_column('simple_tasks', 'description',
    ...
    sa.Column('processor_type', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.Column('external_id', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('status', sa.VARCHAR(length=20), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['issue_id'], ['issue.id'], name=op.f('output_issue_id_fkey'), ondelete='CASCADE'),
    ...
    sa.Column('classification', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['message_id'], ['message.id'], name=op.f('issue_message_id_fkey'), ondelete='CASCADE'),
    ...
    sa.Column('usage_stats', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('id', name=op.f('llmprovider_pkey'))
    )
    op.create_table('stream',
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('id', sa.BIGINT(), server_default=sa.text("nextval('stream_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('source_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('type', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.Column('external_id', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('config', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['source_id'], ['source.id'], name='stream_source_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='stream_pkey'),
    sa.UniqueConstraint('source_id', 'external_id', name='uq_stream_source_external', postgresql_include=[], postgresql_nulls_not_distinct=False),
    ...
    sa.ForeignKeyConstraint(['stream_id'], ['stream.id'], name=op.f('processingjob_stream_id_fkey'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('processingjob_pkey'))
    )
    op.create_table('source',
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('id', sa.BIGINT(), server_default=sa.text("nextval('source_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('type', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.Column('name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('config', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True),
    sa.Column('is_active', sa.BOOLEAN(), autoincrement=False, nullable=False),
    ...
    sa.Column('external_message_id', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['source_id'], ['source.id'], name=op.f('message_source_id_fkey'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['stream_id'], ['stream.id'], name=op.f('message_stream_id_fkey'), ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id', name=op.f('message_pkey')),
    sa.UniqueConstraint('source_id', 'stream_id', 'external_message_id', name=op.f('uq_msg_src_stream_extid'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    op.create_index(op.f('ix_message_thread_key'), 'message', ['thread_key'], unique=False)
