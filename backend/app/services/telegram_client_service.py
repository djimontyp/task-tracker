...
class TelegramClientService:
    ...
    async def connect(self, phone: str = None):
        ...
        if not self.api_id or not self.api_hash:
            raise ValueError("No API credentials. Set TELEGRAM_API_ID and TELEGRAM_API_HASH.")
        ...
        if not await self.client.is_user_authorized():
            ...
            raise RuntimeError("Session expired or invalid. Regenerate using backend/scripts/generate_session.py")
