...
def test_ollama_initialization():
    ...
    config = {"model": settings.ollama_model, "base_url": settings.ollama_base_url}
...
async def main():
    ...
    test_cases = [
        ...
        {"name": "Питання", "message": "Допоможіть зрозуміти, як працює система автентифікації?", "type": "both"},
        {
