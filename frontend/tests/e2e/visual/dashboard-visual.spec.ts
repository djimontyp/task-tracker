...
const MOCK_TOPICS = {
  items: [
    { id: '1', name: 'Productivity', icon: 'Zap', color: '#F59E0B', updated_at: '2024-03-10T12:00:00Z' },
    { id: '2', name: 'Strategy', icon: 'Target', color: '#3B82F6', updated_at: '2024-03-09T16:45:00Z' },
    { id: '3', name: 'Development', icon: 'Code', color: '#10B981', updated_at: '2024-03-08T09:15:00Z' },
    { id: '4', name: 'Marketing', icon: 'Megaphone', color: '#EC4899', updated_at: '2024-03-07T11:20:00Z' },
    { id: '5', name: 'Research', icon: 'Search', color: '#8B5CF6', updated_at: '2024-03-06T14:30:00Z' }
  ]
}
...
test.describe('Dashboard Visual Regression', () => {
  ...
  for (const theme of themes) {
    for (const viewport of viewports) {
      test(`dashboard looks correct in ${theme} mode on ${viewport.name}`, async ({ page }) => {
        // Set viewport
